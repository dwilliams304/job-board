        ...
        <section className="flex-grow list-disc" id="top">
            ...
            <div className="mx-14 space-y-4">
                ...
                <ul className="list-disc px-8">
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to TypeScript Job Board.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to TypeScript Job Board, accessible from <a href="https://dw-project-ts-job-board.vercel.app/" rel="external nofollow noopener" target="_blank">https://dw-project-ts-job-board.vercel.app/</a></p>
                    </li>
                    <li>
                ...
                <h4 className="text-md font-bold">Tracking Technologies and Cookies</h4>
                <div className="px-6">
                ...
                <p className="px-6">If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
                
                <h4 className="text-md font-bold">Law enforcement</h4>
                <p className="px-6">Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
                
                <h4 className="text-md font-bold">Other legal requirements</h4>
                <div className="px-6">
